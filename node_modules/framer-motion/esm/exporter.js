...
import { ControlType, combinedCSSRules, } from './framer';
import fs from 'fs';
...
export function bundle(_a) {
    return __awaiter(this, arguments, void 0, function* ({ cwd: out = '', watch = false, components = {}, breakpoints = {}, signal = undefined, }) {
        ...
        const buildContext = yield context({
            // entryPoints: {
            //     index: url,
            // },
            absWorkingDir: out,
        ...
        function rebuild() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (let file of result.outputFiles) {
                    ...
                    if (lines.length) {
                        logger.error(`found broken links for ${path.relative(out, file.path)}, don't use relative links in Framer components`);
                        lines.forEach((line) => {
                ...
                const cssString = '/* This css file has all the necessary styles to run all your components */\n' +
                    ...
                    '\n\n' +
                    combinedCSSRules
                        .map((x) => ((x === null || x === void 0 ? void 0 : x.startsWith('  ')) ? dedent(x) : x))
                        .join('\n') +
...
export function extractPropControlsSafe(text, name) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
export function extractPropControlsUnsafe(filename, name) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let stdout = yield new Promise((res, rej) => exec(`${JSON.stringify(nodePath)} --input-type=module -e ${JSON.stringify(code)}`, (err, stdout) => {
            if (err) {
                return rej(err);
            }
            res(stdout);
...
export function propControlsToType(controls, fileName) {
    try {
